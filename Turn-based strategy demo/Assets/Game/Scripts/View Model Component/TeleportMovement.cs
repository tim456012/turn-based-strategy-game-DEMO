...
public class TeleportMovement : Movement
{
    public override IEnumerator Traverse(Tile tile)
    {
        ...
        Tweener spin = jumper.RotateToLocal(new Vector3(0, 360, 0), 0.5f, EasingEquations.EaseInQuad);
        ...
        Tweener grow = transform.ScaleTo(Vector3.one, 0.5f, EasingEquations.EaseInBack);
        while(grow != null)
        {
            yield return null;
        }
